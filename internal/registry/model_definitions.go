...
func GetGitHubCopilotModels() []*ModelInfo {
	...
	return []*ModelInfo{
		...
		},
		{
			...
			MaxCompletionTokens: 64000,
			SupportedEndpoints:  []string{"/chat/completions"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "max"}, DynamicAllowed: true},
		},
		{
		...
		},
		{
			...
			MaxCompletionTokens: 64000,
			SupportedEndpoints:  []string{"/chat/completions"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh", "max"}, DynamicAllowed: true},
		},
		{
			ID:                  "claude-opus-4.8",
			Object:              "model",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GPT-6 Sol (Claude-compatible)",
			Description:         "OpenAI GPT-6 Sol via GitHub Copilot, bridged to the Claude Messages API",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GPT-6 Luna (Claude-compatible)",
			Description:         "OpenAI GPT-6 Luna via GitHub Copilot, bridged to the Claude Messages API",
			ContextLength:       872000,
			MaxCompletionTokens: 128000,
			SupportedEndpoints:  []string{"/chat/completions"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh", "max"}, DynamicAllowed: true},
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GPT-6 Astra (Claude-compatible)",
			Description:         "OpenAI GPT-6 Astra via GitHub Copilot, bridged to the Claude Messages API",
			ContextLength:       872000,
			MaxCompletionTokens: 128000,
			SupportedEndpoints:  []string{"/chat/completions"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh", "max"}, DynamicAllowed: true},
